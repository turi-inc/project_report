...
\noindent
The controller is responsible to handle the HTTP requests, and testing the controller.. (PLEASE SOMEONE CONTINUE THIS :p)
\\
...
At total we have about 240 tests, and the test coverage according to CodeClimate is about 90%  /cite{figure2}.
\\
...
\noindent
Working in groups could be very tiresome, when there are issues in the group, or some members does not pull their weight. This has luckily not been the case for this assignment, and I felt that the group worked well together. \\
