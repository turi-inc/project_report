...
The field of software development started in the 1950s with operating systems. The type of software development process used at this time, and still used today, is called the waterfall model. This model focus on having sequential phases of development, see figure \ref{fig:waterfall}.

\begin{figure}
  \centering
  \includegraphics[width=\linewidth]{pictures/waterfall}
  \caption{The waterfall model \cite{waterfall_image}}
  \label{fig:waterfall}
\end{figure}

After the millenia the request for fea 
